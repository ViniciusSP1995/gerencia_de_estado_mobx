...
import 'package:gerencia_de_estado/screens/list_screen.dart';
                ...
                children: <Widget> [ 
                  ...
                  Observer(
                    ...
                    child: RaisedButton(
                      ...
                      child: loginStore.loading ? CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(Colors.white)) : Text('Login'),
